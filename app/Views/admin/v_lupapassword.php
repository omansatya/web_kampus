                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST" >
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="username" value="<?php if($session->getFlashdata('username')) echo $session->getFlashdata('username') ?>" placeholder="name@example.com"m />
